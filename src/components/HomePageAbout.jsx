...
export default function HomePageAbout() {
  return (
    <main className="w-100 cf helvetica dark-gray bg-white pa3 pa4-m pa4-l mw9 center" style={{ paddingBottom: 0 }}>
      <div className="fl w-100 w-25-l pl0-l pr2-m pr3-l mb4 mb4-l">
        <TopImage className="cover pv6 pv7-m pv7-l" />
      </div>
      <div className="fl w-100 w-50-l pr2-l pl2-ns mb4 mb0-l mb4 outline">
        <div className="pa4">
          <h1 className="f4 f2-l fw7 mt0 pv3-l bb-l bb--black">#absoluteandres</h1>
          <p className="lh-copy mt2 mt3-m mt5-l f6">
            ...
            <span className="db-l measure-wide">
              Sígueme en todas mis redes sociales para que seas parte de esta gran familia, aprendas, estemos en
              contacto y no te pierdas todas las sorpresas que tengo para ti. Gracias por visitarme y te mando un
              corazon!
            </span>
          </p>
        </div>
        <footer className="pv4 ph3 ph5-ns tc" style={{ paddingTop: 0 }}>
          <a
          ...
          <a
            ...
            href="https://www.facebook.com/absolutandres"
            title=" Facebook"
          >
            <svg
              fill="currentColor"
          ...
          <a
            className="link hover-silver near-black dib h2 w2 mr3"
            href="https://www.instagram.com/absolutandres/"
            title="Instagram"
          >
            <svg
              fill="currentColor"
          ...
          <a
            className="link hover-silver near-black dib h2 w2 mr3"
            href="https://twitter.com/absolutandres"
            title="Twitter"
          >
            <svg
              fill="currentColor"
      ...
      <div className="cf">
        <div className="fl w-100 w-25-l pl3-l mb3 mb4-l">
          <div
            ...
            style={{
              background:
                'white url(https://res.cloudinary.com/absolutandres/image/upload/v1545515665/41440878_338560243375548_8905659210618882832_n.jpg) center',
            }}
          />
        </div>
      </div>
...
const TopImage = styled.div`
  background: white
    url(https://res.cloudinary.com/absolutandres/image/upload/v1545515665/43143209_2249400161963375_5080166543526725743_n.jpg);
