    ...
    <footer className="pa4 pa5-l black-70 bt b--black-10">
      ...
      <div className="dt dt--fixed w-100">
        <div className="dn dtc-ns v-mid">
          <p className="f7 black-70 dib pr3 mb3">Copyright © absolutandres {format(new Date(), 'YYYY')}</p>
        </div>
        <div className="db dtc-ns black-70 tc tr-ns v-mid">
          <a
            ...
            title="Andres en ingles on Facebook"
          >
          ...
          <a
            ...
            className="link dim dib mr3 black-70"
            title="Andres en ingles on Twitter"
          >
          ...
          <a
            ...
            className="link dim dib mr3 black-70"
            title="Andres en ingles on youtube"
          >
            <svg
              className="dib w2 h2"
              fill="currentColor"
